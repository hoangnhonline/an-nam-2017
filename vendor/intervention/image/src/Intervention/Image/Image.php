 ...
 * @method \Intervention\Image\Image rotate(float $angle, string $bgcolor = '#ff0000')                                                                                    Rotate the current image counter-clockwise by a given angle. Optionally define a background color for the uncovered zone after the rotation.
